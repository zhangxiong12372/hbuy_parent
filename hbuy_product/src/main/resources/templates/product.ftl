...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl" id="loginHeader">你好，请<a href="localhost:8085/" id="titleUser">登录</a>&nbsp; <a href="localhost:8084/" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
        ...
        <div class="white_d">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50" valign="bottom">
                        <td>&nbsp;</td>
                        <td><a href="http://localhost:8086/" class="b_sure">去购物车结算</a><a href="#" class="b_buy">继续购物</a></td>
                    </tr>
                </table>
            ...
            jQuery.ajax({
                ...
                success:function (data) {
                    ...
                    if(data!=""){
                        ...
                        jQuery("#loginHeader").replaceWith('<span class="fl" id="loginHeader">你好，欢迎&nbsp;'+data.uname+'&nbsp;<img src="'+data.userheader+'" width="30px;" height="30px;"/>&nbsp;<span><a href="javascript:void(0)" onclick="exitUser()">注销</a></span>|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>');
                    }else{
                        InterValObj = window.setInterval(getToken, 10000);
                    }
                },
        ...
        exitUser = function () {
            jQuery.ajax({
                ...
                success:function (data) {
                    ...
                    if(data){
                        token=null;
                        jQuery("#loginHeader").replaceWith('<span class="fl" id="loginHeader">你好，请<a href="Login.html">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>');
                    }
                },
                error:function () {
                    alert('服务器异常！！!');
